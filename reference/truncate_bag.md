...
response curves crossing zero, or response curves with multiple
inflection points, for instance.
...
- measure:
  ...
  covariate with zone of influence in a model. It can be one of these:
