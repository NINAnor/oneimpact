...
![GPS data from wild reindeer in summer in the Hardangervidda wild reindeer population in southern Norway](reindeer_gps_points_hardanger_summer.png)
...
# aux - for getting processing times
library(tictoc)
...
# 500
plot_response(bag_summary, dfvar, dat, type = "logit", zoi = TRUE, ci = TRUE,
              wQ_probs = wQ_probs, n_features = 300, plot_mean = FALSE, logx = TRUE)
```
...
mod <- fit_net_logit(f, dat, samples, i = 1, metric = proc_AUC,
                     ...
                     predictor_table = predictor_table_zoi)
```
