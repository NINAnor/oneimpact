...
#---------------------
# Get management area for Austhei - Norway - to match with GPS data
library(sf)
library(terra)
library(DBI)
library(NinaR)
...
# save
sf::st_write(cabins, dsn = "inst/vector/cabins.gpkg", delete_dsn = TRUE)
# now we document by hand
...
# save
sf::st_write(roads_public, dsn = "inst/vector/roads_public.gpkg", delete_dsn = TRUE)
# now we document by hand
...
# save
sf::st_write(roads_private, dsn = "inst/vector/roads_private.gpkg", delete_dsn = TRUE)
# now we document by hand
